...
const achievements = [
    {
        ...
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/achievement-icon.png'
    },
    {
        id: 'day_mode',
        title: '重返光明',
        description: '成功回到普通模式。',
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/achievement-icon-light.png'
    },
    {
        id: 'first_visit',
        title: '初来乍到',
        description: '首次访问网站',
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/first-visit-icon.png'
    },
    {
        id: 'explorer',
        title: '探索者',
        description: '浏览所有内容',
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/explorer-icon.png'
    },
    {
        id: 'night_owl',
        title: '你就熬吧……',
        description: '在凌晨0点至5点使用夜间模式',
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/night-owl-icon.png'
    },
    {
        id: 'early_bird',
        title: '起得早/熬穿了',
        description: '在早上5点至6点访问网站',
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/early-bird-icon.png'
    },
    {
        id: 'bookworm',
        title: '有啥看的',
        description: '在网站上累计阅读超过1小时',
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/bookworm-icon.png',
        maxProgress: 3600
    },
    {
        id: 'problem_solver',
        ...
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/problem-solver-icon.png'
    },
    {
        id: 'continuous_learner',
        title: '有什么值得留恋的吗？',
        description: '连续7天访问网站',
        icon: 'https://jsd.proxy.aks.moe/gh/zygame1314/XiaoyaDownloader@latest/images/continuous-learner-icon.png',
        maxProgress: 7
    },
];

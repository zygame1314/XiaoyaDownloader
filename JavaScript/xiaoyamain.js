...
const achievements = [
    {
        ...
        icon: '/static/achievement-icon.webp'
    },
    {
        id: 'day_mode',
        title: '重返光明',
        description: '成功回到普通模式。',
        icon: '/static/achievement-icon-light.webp'
    },
    {
        id: 'first_visit',
        title: '初来乍到',
        description: '首次访问网站',
        icon: '/static/first-visit-icon.webp'
    },
    {
        id: 'explorer',
        title: '探索者',
        description: '浏览所有内容',
        icon: '/static/explorer-icon.webp'
    },
    {
        id: 'night_owl',
        title: '你就熬吧……',
        description: '在凌晨0点至5点使用夜间模式',
        icon: '/static/night-owl-icon.webp'
    },
    {
        id: 'early_bird',
        title: '起得早/熬穿了',
        description: '在早上5点至6点访问网站',
        icon: '/static/early-bird-icon.webp'
    },
    {
        id: 'bookworm',
        title: '有啥看的',
        description: '在网站上累计阅读超过1小时',
        icon: '/static/bookworm-icon.webp',
        maxProgress: 3600
    },
    {
        id: 'problem_solver',
        ...
        icon: '/static/problem-solver-icon.webp'
    },
    {
        id: 'continuous_learner',
        title: '有什么值得留恋的吗？',
        description: '连续7天访问网站',
        icon: '/static/continuous-learner-icon.webp',
        maxProgress: 7
    },
    {
        id: 'script_switcher',
        ...
        icon: '/static/switcher-icon.webp'
    },
    {
        id: 'all_scripts',
        title: '收集控',
        description: '查看所有三种小雅脚本的详情',
        icon: '/static/collector-icon.webp'
    }
];
